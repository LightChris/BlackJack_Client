...
import threading
import websocket
from temp.client.Classes.PyMain import PyMain
from temp.client.Classes.LoginForm import LoginForm
from temp.client.Classes.ConnectForm import ConnectForm
from temp.client.Classes.TestMessageForm import TestMessageForm
# from Temp.SelectForm import SelectForm
from temp.client.ws_events import *
...
if __name__ == "__main__":
    ...
    ws = websocket.WebSocketApp("ws://192.168.1.101:8888/websocket", on_data=on_data, on_error=on_errors)
